...
const SphereImageGrid: React.FC<SphereImageGridProps> = ({
  ...
  const renderSpotlightModal = () => {
    ...
    return (
      ...
      >
        <div
          className="bg-card rounded-xl max-w-md w-full overflow-hidden border border-accent/30 shadow-glow"
  ...
  if (!isMounted) {
    return (
      <div
        className="bg-secondary/20 rounded-lg animate-pulse flex items-center justify-center"
  ...
  if (!images.length) {
    return (
      <div
        className="bg-secondary/20 rounded-lg border-2 border-dashed border-border flex items-center justify-center"
        style={{ width: containerSize, height: containerSize }}
      >
